...
// 1
  ...
  const dateFilter = users.filter((user) => {
    if (user.registrationDate === '09.10.2021' || user.registrationDate === '10.10.2021' || user.registrationDate === '10.10.2020'){
            return user;
    }
  })
...
// 2
  ...
  const dateFilter1 = users.filter(function(user)  {
    if (user.registrationDate === '09.10.2019' || user.registrationDate === '01.01.2021' || user.registrationDate === '12.10.2021'){
            return user;
    }
  })
